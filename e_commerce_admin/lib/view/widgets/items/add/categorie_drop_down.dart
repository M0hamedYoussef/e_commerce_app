...
class CategorieItemAddDropDown extends StatelessWidget {
  const CategorieItemAddDropDown({super.key});
          ...
          children: [
            ...
            DropdownButtonHideUnderline(
              child: DropdownButton2(
                ...
                value: controller.categoriesList[0]['categorie_id'].toString(),
                onChanged: (String? value) {
                  controller.addItemCategorieId = value!;
                  controller.update();
                },
