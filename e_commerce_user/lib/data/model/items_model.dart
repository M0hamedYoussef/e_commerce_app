import 'package:e_commerce/core/functions/replace.dart';
...
class ItemsModel {
  ...
  ItemsModel.fromJson(Map<String, dynamic> json) {
    ...
    cartItemcolor = json['cart_itemcolor'] ?? 'default';
    ...
    addressLat = double.parse((json['address_lat'] ?? 0).toString());
    addressLong = double.parse((json['address_long'] ?? 0).toString());
